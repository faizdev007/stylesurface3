...
const Navbar: React.FC<NavbarProps> = ({ onOpenModal }) => {
  ...
  return (
    <>
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isMobileMenuOpen ? 'bg-black/90 backdrop-blur-md border-b border-gray-100 py-3 shadow-sm' : 'bg-black/90 py-5'}`}>
